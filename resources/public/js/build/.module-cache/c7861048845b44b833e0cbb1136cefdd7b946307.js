...
var NewsBox = React.createClass({displayName: "NewsBox",
    ...
    render: function() {
        return (
                ...
                React.createElement("input", {name: "title", onChange: this.onChange, value: this.state.title}), 
                React.createElement("input", {name: "author", onChange: this.onChange, value: this.state.author}), 
                React.createElement("textarea", {name: "body", onChange: this.onChange, rows: "5", value: this.state.body}), 
