          ...
          React.createElement("div", null, 
            React.createElement("div", {className: "news-form-box"}, 
              React.createElement("div", {className: "news-form-box-title"}, 
                React.createElement("h3", null, "New News Item")
              ), 
              React.createElement("form", {onSubmit: this.handleSubmit}, 
                ...
                React.createElement("div", {className: "inputGroup"}, 
                  React.createElement("textarea", {className: "form-control", name: "body", onChange: this.onChange, rows: "5", value: this.state.body, placeholder: "Message ..."})
                ), 
                React.createElement("button", {className: "btn", type: "button"}, "Submit")
              )
            ), 
