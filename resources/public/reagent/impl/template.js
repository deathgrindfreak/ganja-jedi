...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__16904__auto__,writer__16905__auto__,opt__16906__auto__){
return cljs.core._write.call(null,writer__16905__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__16325__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__16325__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__16325__auto__)){
return or__16325__auto__;
} else {
...
var G__24886 = o;
(G__24886[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
var old_24890 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_24890))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_24890)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__16313__auto__ = (node === document.activeElement);
if(and__16313__auto__){
var and__16313__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__16313__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__24893 = jsprops;
(G__24893["defaultValue"] = value);

(G__24893["onChange"] = ((function (G__24893,v,value,on_change){
return (function (p1__24891_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__24891_SHARP_);
});})(G__24893,v,value,on_change))
);
...
var vec__24895 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__24895,(0),null);
var id = cljs.core.nth.call(null,vec__24895,(1),null);
var class$ = cljs.core.nth.call(null,vec__24895,(2),null);
...
var temp__4427__auto__ = (function (){var G__24899 = cljs.core.meta.call(null,v);
var G__24899__$1 = (((G__24899 == null))?null:reagent.impl.template.get_key.call(null,G__24899));
return G__24899__$1;
})();
if((temp__4427__auto__ == null)){
...
var jsprops = {"argv": v};
var G__24901_24902 = v;
var G__24901_24903__$1 = (((G__24901_24902 == null))?null:reagent.impl.template.key_from_vec.call(null,G__24901_24902));
var G__24901_24904__$2 = (((G__24901_24903__$1 == null))?null:(jsprops["key"] = G__24901_24903__$1));
...
var p = (function (){var temp__4427__auto__ = (function (){var G__24907 = cljs.core.meta.call(null,argv);
var G__24907__$1 = (((G__24907 == null))?null:reagent.impl.template.get_key.call(null,G__24907));
return G__24907__$1;
})();
if((temp__4427__auto__ == null)){
return jsprops;
...
var G__24908 = (((jsprops == null))?{}:jsprops);
(G__24908["key"] = key);
...
var G__24909 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__24909;
continue;
}
} else {
...
var n__17209__auto___24910 = a.length;
var i_24911 = (0);
while(true){
if((i_24911 < n__17209__auto___24910)){
(a[i_24911] = reagent.impl.template.as_element.call(null,(a[i_24911])));

var G__24912 = (i_24911 + (1));
i_24911 = G__24912;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__17209__auto___24913 = a.length;
var i_24914 = (0);
while(true){
if((i_24914 < n__17209__auto___24913)){
var val_24915 = (a[i_24914]);
if((cljs.core.vector_QMARK_.call(null,val_24915)) && ((reagent.impl.template.key_from_vec.call(null,val_24915) == null))){
(o["no-key"] = true);
} else {
}

(a[i_24914] = reagent.impl.template.as_element.call(null,val_24915));

var G__24916 = (i_24914 + (1));
i_24914 = G__24916;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__16313__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__16313__auto__){
return (ctx["no-key"]);
} else {
return and__16313__auto__;
...
var G__24918 = (cljs.core.count.call(null,argv) - first_child);
switch (G__24918) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__24918){
